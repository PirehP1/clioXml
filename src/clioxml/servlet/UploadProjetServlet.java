...
*/                 
public class UploadProjetServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req,
    	...
    	String projet_name = req.getParameter("projet_name");
        ...
        ImportProjetJob j = new ImportProjetJob(p);
        j.setUser(user);
        j.setProjectName(projet_name);
