...
*/                 
public class UploadXsltServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req,
        ...
        */
        ...
        for (Part part : req.getParts()) {
            ...
            part.write(fileName);
            FILE_NAME = tempDir.getAbsolutePath() + File.separator + fileName;
